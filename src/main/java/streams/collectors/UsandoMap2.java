...
public class UsandoMap2 {
    public static void main(String[] args) {
        ...
        //POIS PARA CADA ITERAÇÃO ESTAMOS CONVERTENDO int PRIMITIVO PARA Integer WRAPPER
        //UMA VEZ QUE getPontos DEVOLVE UM int E O apply DA INTERFACE Function QUE O METHOD REFERENCE PASSA PARA O map
        //DEVOLVE Integer. E ISSO PODE DAR UM OVERHEAD PARA LISTAS GRANDES OU MUITAS CHAMADAS A ESSA PARTE DO CODE
